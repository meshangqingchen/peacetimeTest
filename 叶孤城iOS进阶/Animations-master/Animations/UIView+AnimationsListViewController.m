...
+ (UILabel *)animationsListViewControllerNormalHeadLabel {
    ...
    NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc] initWithString:@"Animations"];//Animations
    headlinelabel.attributedText = attributedString;
    [headlinelabel sizeToFit];
//    headlinelabel.backgroundColor  = [UIColor yellowColor];
...
+ (UILabel *)animationsListViewControllerHeadLabel {
    ...
    [attributedString addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithRed:0.203  green:0.598  blue:0.859 alpha:1]range:NSMakeRange(1, 1)];
