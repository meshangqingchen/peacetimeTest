...
- (void)setOn:(BOOL)on {
    ...
    if (on) {
        ...
        NSLog(@"=_eyesLayer.frame.size.width==%f",_eyesLayer.frame.size.width);
...
//        _eyesLayer.backgroundColor = [UIColor redColor].CGColor;
        ...
        _eyesLayer.backgroundColor = [UIColor yellowColor].CGColor;
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag {
    if (flag) {
        ...
        // start eyes ending animation EyesMoveStartAnimationKey 移动到中间
...
//mouthKeyFrameAnimationWidthOffSet
