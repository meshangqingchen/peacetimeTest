 ...
 */
@property (assign, nonatomic) BOOL shouldDecompressImages;// 是否解压缩

/**
 *  disable iCloud backup [defaults to YES]
 */
@property (assign, nonatomic) BOOL shouldDisableiCloud;   //进制iCoud备份

/**
 * use memory cache [defaults to YES]
 */
@property (assign, nonatomic) BOOL shouldCacheImagesInMemory; //内存缓存
